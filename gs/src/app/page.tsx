...
export default function Home() {
  return (
    <>
      {/* Header */}
      <header className="w-full h-[200px] border-t border-green-700 bg-green-600 flex justify-center items-center p-4">
      ...
      <section className="w-full flex justify-evenly items-center gap-3 my-4 md:h-[600px] celular:flex-col-reverse celular:h-max celular:py-4 celular:px-4">
        <div className="w-1/2 flex justify-center items-center flex-col tablet:w-full">
          <h3 className="text-5xl font-medium pb-16 text-center text-green-700 celular:text-3xl">
            Quem nós somos?
          </h3>
          <p className="text-3xl font-light w-3/4 text-center text-green-600 celular:text-lg">
      ...
      <section className="w-full h-[600px] bg-green-600 flex justify-center items-center flex-col px-4 celular:h-auto celular:py-10">
      ...
      <section className="w-5/6 flex justify-evenly items-center gap-3 my-4 h-[600px] m-auto celular:w-full celular:px-4">
        ...
        <div className="w-3/4 flex justify-center items-center flex-col tablet:w-full celular:w-full">
          <h2 className="text-5xl font-medium text-center pb-[50px] text-green-700 celular:text-3xl celular:pb-7">
            O que mais te oferecemos?
          </h2>
          <p className="text-3xl font-light text-green-600 text-center w-3/4 celular:text-[20px]">
